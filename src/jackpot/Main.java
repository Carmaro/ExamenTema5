...
public class Main extends javax.swing.JFrame {
    ...
    int introducido;
    public double valor50 = 0.50;
    public double valor1 = 1.00;
    public double valor2 = 2.00;
    public double saldo;
    public double PrecioJugada = 0.50;
   ...
   /**
    ...
    private void jButtonPalancaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPalancaActionPerformed
        ...
        ArrayList<String> combinacinesList = new ArrayList();
        combinacinesList.add(String.valueOf(new ImageIcon(getClass().getResource("/imagenes/0.png"))));
        combinacinesList.add(String.valueOf(new ImageIcon(getClass().getResource("/imagenes/1.png"))));
        combinacinesList.add(String.valueOf(new ImageIcon(getClass().getResource("/imagenes/2.png"))));
        combinacinesList.add(String.valueOf(new ImageIcon(getClass().getResource("/imagenes/3.png"))));
        combinacinesList.add(String.valueOf(new ImageIcon(getClass().getResource("/imagenes/4.png"))));
        
        
        
        
        if(saldo != 0){
        jLabelSaldo.setText(String.valueOf(saldo - PrecioJugada));
        }else{
            JOptionPane.showMessageDialog(this, "Introduzca Creditos");
        }
         if(saldo == 0){
    ...
    private void jButton50centActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton50centActionPerformed
        ...
        double saldo50 = saldo += valor50;
        jLabelSaldo.setText(String.valueOf(saldo50));
    ...
    double saldo1 =saldo += valor1;  
    jLabelSaldo.setText(String.valueOf(saldo1));   
    ...
    private void jButton2euroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2euroActionPerformed
        ...
        jLabelSaldo.setText(String.valueOf(saldo2));
    ...
    private void jButtonCobrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCobrarActionPerformed
        if(deposito < 0){
            JOptionPane.showMessageDialog(this, "Deposito vacio. Pase por caja");
        }
        ...
        jLabelPremio.setText(String.valueOf(0.00));
